...
class UserInput(BaseModel):
    ...
    weight: Annotated[float, Field(..., gt=0, lt=1000, description="Weight of the user in kg")]
    height: Annotated[float, Field(..., gt=0, lt=3, description="Height of the user in m")]
    incompe_lpa: Annotated[float, Field(..., gt=0, description="Annual salary of the user in lpa")]
